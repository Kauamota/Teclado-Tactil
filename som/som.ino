//Definindo o pino das teclas e do buzzer.
#define buzzer 10
#define botao1 2
#define botao2 3
#define botao3 4
...
void setup() {
  //Declarando o buzzer como saída de sinal, e os botões como entradas em estado "Pull UP", o que significa que seu valor lógico é 1.
...
void loop() {
  ...
  int valor1 = analogRead(A0); //Criando uma variável com o valor do pino analógico A0.
  
 if (digitalRead(botao1) == LOW) { //Se botão1 estiver pressionado, envie a seguinte frequência/nota para a caixa de som:
    tone(buzzer,262);
}else if(digitalRead(botao2) == LOW){ //O mesmo se repete para todos os outros.
    tone(buzzer, 277);
